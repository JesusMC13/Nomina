    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 py-3 px-4 bg-gradient-primary text-white rounded-lg">
            <div>
                <h2 class="h3 mb-1 font-weight-bold">
                    <i class="fas fa-clock mr-2"></i>Editar Turno
                </h2>
            ...
            <span class="badge badge-light badge-pill shadow-sm">
                <i class="fas fa-id-badge mr-1"></i> ID: {{ $turno->ID_turno }}
            </span>
            </div>
        </div>
        ...
        <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
            <div class="card-body p-5">
                <form action="{{ route('adminn.turnos.update', $turno->ID_turno) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        <h5 class="font-weight-bold text-primary mb-4">
                            <i class="fas fa-edit mr-2"></i>Información del Turno
                        </h5>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <small class="form-text text-muted">
                                    Ingrese el nombre descriptivo del turno
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_entrada') is-invalid @enderror"
                                           ...
                                           value="{{ old('hora_entrada', substr($turno->hora_entrada, 0, 5)) }}"
                                           required>
                                    @error('hora_entrada')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_salida') is-invalid @enderror"
                                           ...
                                           value="{{ old('hora_salida', substr($turno->hora_salida, 0, 5)) }}"
                                           required>
                                    @error('hora_salida')
                                    <div class="invalid-feedback">
                                        {{ $message }}
