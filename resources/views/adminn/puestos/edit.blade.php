...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 py-3 px-4 bg-gradient-primary text-white rounded-lg">
            <div>
                <h2 class="h3 mb-1 font-weight-bold">
                    <i class="fas fa-user-tie mr-2"></i>Editar Puesto
                </h2>
            ...
            <span class="badge badge-light badge-pill shadow">
                <i class="fas fa-id-badge mr-1"></i> ID: {{ $puesto->id_puesto }}
            </span>
            </div>
        </div>
        ...
        <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
            <div class="card-body p-5">
                <form action="{{ route('adminn.puestos.update', $puesto->id_puesto) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        <h5 class="font-weight-bold text-primary mb-4">
                            <i class="fas fa-edit mr-2"></i>Información del Puesto
                        </h5>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <small class="form-text text-muted">
                                    Modifique el nombre del puesto según sea necesario
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('salario_base') is-invalid @enderror"
                                           id="salario_base" name="salario_base"
                                           value="{{ old('salario_base', $puesto->salario_base) }}"
                                           required placeholder="Ej: 15000.00">
                                ...
                                <small class="form-text text-muted">
                                    Actualice el salario base mensual
                                </small>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Formato automático para salario
        document.getElementById('salario_base').addEventListener('blur', function() {
            if(this.value) {
